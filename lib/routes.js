...
module.exports = function (page) {
  ...
  //TODO: Use .cache() and .fallback() to refactor the loading of this – to cache the promise and fallback!
  router.get('/', !page.config.features.frontpage ? function (req, res) { res.redirect('/admin'); } : function (req, res, next) {
    ...
    result.then(function (data) {
      ...
      var dictionary = dictionaries.dictionary;
      var jsDictionary = dictionaries.jsDictionary;
